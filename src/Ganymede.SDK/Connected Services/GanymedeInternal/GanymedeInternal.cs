...
namespace Ganymede.SDK
{
    ...
    internal partial class Client 
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<BooleanApiResponse> ApiExternalV1IssuerwalletseedsIssuerwalletsLockAsync(System.Guid institutionId, System.Guid issuerWalletSeedId, System.Guid issuerWalletId, SimpleAccessCredentialsDto body)
        {
            return ApiExternalV1IssuerwalletseedsIssuerwalletsLockAsync(institutionId, issuerWalletSeedId, issuerWalletId, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<BooleanApiResponse> ApiExternalV1IssuerwalletseedsIssuerwalletsLockAsync(System.Guid institutionId, System.Guid issuerWalletSeedId, System.Guid issuerWalletId, SimpleAccessCredentialsDto body, System.Threading.CancellationToken cancellationToken)
        {
            if (institutionId == null)
                throw new System.ArgumentNullException("institutionId");
    
            if (issuerWalletSeedId == null)
                throw new System.ArgumentNullException("issuerWalletSeedId");
    
            if (issuerWalletId == null)
                throw new System.ArgumentNullException("issuerWalletId");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/external/v1/issuerWalletSeeds/{issuerWalletSeedId}/issuerWallets/{issuerWalletId}/lock");
            ...
            urlBuilder_.Replace("{issuerWalletSeedId}", System.Uri.EscapeDataString(ConvertToString(issuerWalletSeedId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{issuerWalletId}", System.Uri.EscapeDataString(ConvertToString(issuerWalletId, System.Globalization.CultureInfo.InvariantCulture)));
